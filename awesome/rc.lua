...
beautiful.init("/home/gdelattr/.config/awesome/themes/default/theme.lua")
...
tags = {
    settings = {
        -- middle screen
        {
            names = { "web", "sdev", "sql", "web-dev", "modem", "mozg", "7", "8", "9" },
            layout = { layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5]}
        },
        -- left screen
        {
            names  = { "web", "mail", "jab", "desk", "log", "sdev" },
            layout = { layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5] }
        },
        -- right screen
        {
            names = { "web", "sdev", "web-dev", "modem", "mozg", "6", "7", "8", "9" },
            layout = { layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5], layouts[5]}
        }
    }
}
...
globalkeys = awful.util.table.join(
    ...
    -- Language mapping
    awful.key({ modkey,           }, "F11", function () awful.util.spawn("setxkbmap us") end),
