 ...
 */
static const char * const BAR_FONT = "DejaVuSansMono Nerd Font Mono:style=Book:size=10:antialias=true:autohint=true";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#101010";
static const char * const WIN_FS_COLOR = "#101010";
static const char * const SEL_COLOR    = "#EBEBEB";
static const char * const BAR_BG_COLOR = "#101010";
static const char * const BAR_FG_COLOR = "#EBEBEB";
...
static const int thumb_sizes[] = { 32, 64, 96, 128, 160, 512 };
